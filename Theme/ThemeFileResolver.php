...
class ThemeFileResolver
{
    ...
    public function resolveStyleFiles(
        ...
        return $this->resolve(
            ...
            $configurationCollection,
            $onlySourceFiles,
            static fn (FrontendPluginConfiguration $configuration) => $configuration->getStyleFiles(),
            [],
            [],
            []
        );
    ...
    private function processBundleRelativeFile(
        ...
        $fs = $this->themeFilesystemResolver->getFilesystemForFrontendConfig($bundleConfig);
    ...
    private function processDirectFile(
        ...
        throw ThemeException::themeCompileException(
            ...
            \sprintf(
                ...
                $filepath,
                'Did you forget to build the theme? Try running ./bin/build-frontend.sh'
            )
        );
    }
    ...
    private function processNamespaceReference(
        ...
        if ($filepath === '@FrontendBootstrap') {
            $this->addFrontendBootstrapFile($processedFiles, $resolvedFiles);
    ...
    /**
     * Appends the Frontend bootstrap SCSS entry point with its vendor mapping.
     *
     * @param array<string, bool> $processedFiles
     */
    private function addFrontendBootstrapFile(array &$processedFiles, FileCollection $resolvedFiles): void
    {
        $bootstrapPath = __DIR__ . '/../Resources/app/frontend/src/scss/base.scss';
