...
class ThemeCreateCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('with-snippets', null, null, 'Also scaffold frontend snippet files')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            if ($withScss) {
                $this->createDirectory($directory . '/src/Resources/app/frontend/src/scss/abstracts');
                $this->createDirectory($directory . '/src/Resources/app/frontend/src/scss/base');
                $this->createDirectory($directory . '/src/Resources/app/frontend/src/scss/components');
                $this->createDirectory($directory . '/src/Resources/app/frontend/src/scss/layout');
                $this->createDirectory($directory . '/src/Resources/app/frontend/src/scss/pages');
            }
        ...
        $this->filesystem->touch($directory . '/src/Resources/app/frontend/src/assets/.gitkeep');
        $this->filesystem->touch($directory . '/src/Resources/app/frontend/src/main.js');
        $this->filesystem->touch($directory . '/src/Resources/app/frontend/dist/frontend/js/' . $snakeCaseName . '/' . $snakeCaseName . '.js');
        ...
        if ($withSnippets) {
            $this->filesystem->dumpFile($directory . '/src/Resources/snippet/frontend.en-GB.json', $this->getSnippetTemplate());
            $this->filesystem->dumpFile($directory . '/src/Resources/snippet/frontend.zh-CN.json', $this->getSnippetTemplate());
        }

        if ($withScss) {
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/base.scss', $this->getBaseScssTemplate());
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/abstracts/_variables.scss', "// Theme-specific SCSS variables.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/abstracts/_mixins.scss', "// Theme-specific SCSS mixins.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/base/_reset.scss', "// Base element resets.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/base/_typography.scss', "// Base typography styles.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/components/_buttons.scss', "// Button component styles.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/layout/_header.scss', "// Header layout styles.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/layout/_footer.scss', "// Footer layout styles.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/layout/_navigation.scss', "// Navigation layout styles.\n");
            $this->filesystem->dumpFile($directory . '/src/Resources/app/frontend/src/scss/pages/_home.scss', "// Homepage-specific styles.\n");
        } else {
            $this->filesystem->touch($directory . '/src/Resources/app/frontend/src/scss/base.scss');
        }
        ...
        return <<<EOL
{
  ...
  "extra": {
    "contena-plugin-class": "#namespace#\\\\#class#",
    "label": {
      "en-GB": "Theme #namespace# plugin",
      "zh-CN": "主题 #namespace# 插件"
    }
  }
}
EOL;
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/contena/contena/trunk/src/Core/System/SystemConfig/Schema/config.xsd">
