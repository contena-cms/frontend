...
namespace Contena\Frontend\Theme\Controller;
...
class ThemeController extends AbstractController
{
    ...
    {
        return new JsonResponse($this->themeService->getPlainThemeConfiguration($themeId, $context));
    }
    ...
    /**
     * Assigns a theme to a specific channel.
     *
     * This endpoint links a theme to a channel, making it the active theme
     * for that channel. This determines the visual appearance and styling of the
     * frontend for members visiting that channel. Only one theme can be
    ...
    {
        // Defer the switch until compilation finished so the frontend is never left without CSS.
     ...
     * The response format differs based on the Contena version for backward compatibility.
     *
     * @param string $themeId The unique identifier of the theme
     * @param Context $context The application context containing user and system information
     *
    ...
    {
        return new JsonResponse($this->themeService->getThemeConfigurationFieldStructure($themeId, $context));
    }
