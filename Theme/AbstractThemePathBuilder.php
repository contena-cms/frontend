...
abstract class AbstractThemePathBuilder
{
    ...
    /**
     * `assemblePath()` should return the path to the theme files for the given channel and theme.
     ...
     * It should save the seed so that it will be used for subsequent calls to `assemblePath()`.
     */
