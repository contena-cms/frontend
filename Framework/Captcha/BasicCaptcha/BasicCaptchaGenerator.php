...
class BasicCaptchaGenerator extends AbstractBasicCaptchaGenerator
{
    ...
    private string $backgroundPath = __DIR__ . '/../../../Resources/app/frontend/dist/assets/captcha/background.png';

    private string $fontPath = __DIR__ . '/../../../Resources/app/frontend/dist/assets/captcha/font.ttf';
