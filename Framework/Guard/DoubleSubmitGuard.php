...
/**
 * Suppresses a frontend submission that re-submits an already consumed context token.
 *
...
{
    private const float LOCK_TTL = 30.0;

    private const float LOCK_WAIT_TIMEOUT = 5.0;

    private const int LOCK_RETRY_DELAY_US = 50000;

    private const int MARKER_TTL = 10;
     ...
     */
    public function guard(string $scope, ChannelContext $context, \Closure $submit): bool
    {
     ...
     * @param \Closure(): void $submit
     */
    private function submitAndMark(\Closure $submit, ChannelContext $context, string $scope, string $token, string $markerKey): void
    {
        $submitted = false;
