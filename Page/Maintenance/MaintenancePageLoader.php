...
class MaintenancePageLoader
{
    ...
    public function load(string $landingPageId, Request $request, ChannelContext $context): MaintenancePage
    {
        $page = MaintenancePage::createFrom($this->genericLoader->load($request, $context));
