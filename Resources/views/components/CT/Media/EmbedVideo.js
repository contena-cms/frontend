...
export default class MediaEmbedVideo extends ContenaComponent {
    static options = {
        videoUrl: null,
        videoTitle: null,
        cookieName: null,
    ...
    init() {
        this.acceptButton = this.el.querySelector('.ct-media-embed-video__accept');
    ...
    replaceWithVideo() {
        ...
        iframe.classList.add('ct-media-embed-video__video');
