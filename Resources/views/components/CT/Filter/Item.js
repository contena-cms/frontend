export default class FilterItem extends ContenaComponent {

    init() {
        this.filterElement = this.el.querySelector('.ct-filter');
        this.countBadge = this.el.querySelector('.ct-filter-item__count');
