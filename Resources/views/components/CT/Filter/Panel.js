export default class FilterPanel extends ContenaComponent {
    ...
    init() {
        this.expandButton = this.el.querySelector('.ct-filter-panel__expand');

        if (!this.expandButton) {
            return;
        }

        this.expandText = this.expandButton.querySelector('.ct-filter-panel__expand-text');
        this.collapseText = this.expandButton.querySelector('.ct-filter-panel__collapse-text');
        this.filterItems = this.el.querySelectorAll('.ct-filter-item');
