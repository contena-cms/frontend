export default class BlogListing extends ContenaComponent {
    ...
    registerEvents() {
        ...
        Contena.on('Pagination:Change', this.handlePageChange.bind(this));
        Contena.on('LayoutSwitch:Change', this.handleLayoutChange.bind(this));
        Contena.on('FilterSorting:Change', this.handleSortingChange.bind(this));
        Contena.on('Filter:Remove', this.handleFilterRemove.bind(this));
    }
    ...
    destroy() {
        ...
        Contena.off('Pagination:Change', this.handlePageChange.bind(this));
        Contena.off('LayoutSwitch:Change', this.handleLayoutChange.bind(this));
        Contena.off('FilterSorting:Change', this.handleSortingChange.bind(this));
        Contena.off('Filter:Remove', this.handleFilterRemove.bind(this));
    }
}
