export default class MediaGallery extends ContenaComponent {
    static options = {
        showMagnifier: true,
    ...
    init() {
        ...
        this.thumbnailButtons = this.el.querySelectorAll('.ct-thumbnail-nav__button');
        this.thumbnailNavInner = this.el.querySelector('.ct-thumbnail-nav__inner');
        this.thumbnailNavScrollBackBtn = this.el.querySelector('.ct-thumbnail-nav__scroll-control.is--backward');
        this.thumbnailNavScrollFordwardBtn = this.el.querySelector('.ct-thumbnail-nav__scroll-control.is--forward');

        // Previews scroll container
        this.previewsContainer = this.el.querySelector('.ct-media-gallery__previews');
        this.previewItems = this.el.querySelectorAll('.ct-media-gallery__preview-item');

        // Counter
        this.counterBadge = this.el.querySelector('.ct-media-galley__counter-info');

        // Arrow navigation buttons
        this.backwardBtn = this.el.querySelector('.ct-media-gallery__nav-button.is--backward');
        this.forwardBtn = this.el.querySelector('.ct-media-gallery__nav-button.is--forward');
    ...
    initLightbox() {
        ...
        this.modalElement = this.el.closest('.modal.ct-media-gallery-lightbox');
    ...
    clampClickZoomPan(container, zoom) {
        ...
        const visLeft = this.clampClickZoomAxis(zoom.imageOffsetX + originShiftX + zoom.panX, scaledWidth, viewport.width);
        const visTop = this.clampClickZoomAxis(zoom.imageOffsetY + originShiftY + zoom.panY, scaledHeight, viewport.height);
