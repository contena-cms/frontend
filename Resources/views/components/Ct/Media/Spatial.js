import { QuickView } from '@contena-ag/dive/quickview';

export default class MediaSpatial extends ContenaComponent {
    static options = {
    ...
    init() {
        this.viewer = null;
        this.canvasElement = this.el.querySelector('.ct-media-spatial__canvas');
        this.loaderElement = this.el.querySelector('.ct-media-spatial__loader');
