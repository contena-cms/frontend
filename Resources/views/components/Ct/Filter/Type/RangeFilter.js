export default class RangeFilter extends ContenaComponent {
    ...
    init() {
        this.rangeMinInput = this.el.querySelector('.ct-range-filter__min-input');
        this.rangeMaxInput = this.el.querySelector('.ct-range-filter__max-input');
    ...
    registerEvents() {
        ...
        Contena.on(`Filter:Remove:${this.minParamName}`, this.handleFilterRemove.bind(this));
        Contena.on(`Filter:Remove:${this.maxParamName}`, this.handleFilterRemove.bind(this));
    }
    ...
    handleRangeInput(event) {
        ...
        ({ paramName, value, label, unit } = Contena.emitInterception('RangeFilter:PreChange', { paramName, value, label, unit }));

        Contena.emit('RangeFilter:Change', { paramName, value, label, unit });
        Contena.emit('Filter:Change', { paramName, value, label, unit });
    ...
    destroy() {
        ...
        Contena.off(`Filter:Remove:${this.minParamName}`, this.handleFilterRemove.bind(this));
        Contena.off(`Filter:Remove:${this.maxParamName}`, this.handleFilterRemove.bind(this));
    }
}
