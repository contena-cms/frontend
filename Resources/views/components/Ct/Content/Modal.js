export default class Modal extends ContenaComponent {
    ...
    init() {
        this.modalBody = this.el.querySelector('.ct-modal__body');
        this.modalTitle = this.el.querySelector('.ct-modal__title');
    ...
    renderContent(content) {
        ({ content } = Contena.emitInterception('Modal:PreRenderContent', { content }));
