...
export default class FocusHandler {
    ...
    constructor(defaultHistoryKey = 'lastFocus', defaultStorageKeyPrefix = 'ct-last-focus') {
     ...
     * By default, the given key will be prefixed with the `defaultStorageKeyPrefix` "ct-last-focus".
    ...
    saveFocusStatePersistent(focusStorageKey, uniqueSelector) {
        ...
        // key: "ct-last-focus-my-example-element" | value: "#my-example-unique-id"
        try {
