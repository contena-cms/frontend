...
/**
 * Base class for analytics events that need to subscribe to other Contena plugin events.
 *
 * This class subscribes to events emitted by frontend plugins (e.g., AddToCart, SearchWidget)
