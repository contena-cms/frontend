...
import type ContenaComponent from './component';
...
/**
 * Global Contena class.
 *
 * This class is the central point for all component-system related functionality.
 * It is a singleton and can be accessed via `window.Contena`.
 *
 * @internal
 * @ct-package framework
 */
class Contena extends EventEmitter {

    // Singleton instance.
    public static instance: Contena;
    ...
    private componentRegistry: Map<string, typeof ContenaComponent | null> = new Map();
    ...
    private instanceIndexByElement: WeakMap<Node, Map<string, ContenaComponent>> = new WeakMap();
     ...
     */
    public async getComponent(componentName: string | null | undefined): Promise<typeof ContenaComponent | undefined> {
        if (!componentName) {
            return undefined;
        }
        ...
        let component: typeof ContenaComponent | undefined;
        try {
            /**
             ...
             */
            const module = await import(/* webpackIgnore: true */ /* @vite-ignore */ componentSpecifier) as { default?: typeof ContenaComponent };
     ...
     */
    public getComponentInstances(componentName: string | RegExp): ContenaComponent[] {
     ...
     */
    public getComponentInstanceByElement(componentName: string, element: Node): ContenaComponent | undefined {
    ...
    public initializeComponentOnElement(
        componentName: string,
        component: typeof ContenaComponent,
        element: HTMLElement,
    ): ContenaComponent | undefined {
        ...
        const elementInstances = this.instanceIndexByElement.get(element) ?? new Map<string, ContenaComponent>();
    ...
    public callMethod(componentName: string | RegExp, methodName: string, ...args: unknown[]): void {
        ...
        componentInstances.forEach(instance => {
            if (instance[methodName as keyof ContenaComponent] &&
                typeof instance[methodName as keyof ContenaComponent] === 'function') {
                (instance[methodName as keyof ContenaComponent] as (...fnArgs: unknown[]) => void).call(instance, ...args);
            }
        });
    }
    ...
    private async initializeComponents(): Promise<void> {
        ...
        const components = new Map<string, typeof ContenaComponent>();
...
const contena: Contena = new Contena();
window.Contena = contena;
export { contena as Contena };