...
jest.mock('@contena-ag/dive', () => ({ DIVE: {} }));
jest.mock('@contena-ag/dive/ar', () => ({ ARSystem: {} }));
jest.mock('@contena-ag/dive/quickview', () => ({ QuickView: {} }));
jest.mock('@contena-ag/dive/animation', () => ({ AnimationSystem: {} }));
