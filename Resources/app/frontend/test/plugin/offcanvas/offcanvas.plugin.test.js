...
describe('OffCanvas tests', () => {
    ...
    it('removes only offcanvas from the DOM created by OffCanvasSingleton and ignores other Bootstrap offcanvas', () => {
        ...
        // Open the contena OffCanvas via OffCanvasSingleton
        OffCanvas.open('Interesting content');
        jest.runAllTimers();

        // Ensue contena OffCanvas was opened
        expect(OffCanvas.exists()).toBe(true);
        ...
        // Close the contena OffCanvas
        OffCanvas.close();
        jest.runAllTimers();

        // Ensure contena OffCanvas is no longer existing in the DOM
