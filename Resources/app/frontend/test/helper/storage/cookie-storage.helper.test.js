...
describe('cookie-storage.helper.js', () => {
    ...
    test('it sets the cookie with a custom path when channelCookiePath is set', () => {
        window.channelCookiePath = '/custom-sales-channel-path';
        ...
        delete window.channelCookiePath;
    });

    test('it removes the cookie with a custom path when channelCookiePath is set', () => {
        window.channelCookiePath = '/custom-sales-channel-path';

        const cookieSpy = jest.spyOn(document, 'cookie', 'set');

        CookieStorageHelper.removeItem('path-test-cookie');
    ...
    test('it uses root path when channelCookiePath is not set', () => {
        delete window.channelCookiePath;
