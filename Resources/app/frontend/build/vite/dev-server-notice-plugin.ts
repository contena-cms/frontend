 ...
 * output with a Contena-specific notice.
 *
 ...
 * CSS, and SCSS assets consumed by the running Contena frontend. Opening
        ...
        configureServer(server) {
            server.printUrls = () => {
                ...
                server.config.logger.info(
                    '\n' +
                    '  ' + pc.green('➜') + pc.green('  Frontend dev server ready') + ' (Port: ' + port + ').\n' +
                    '     Open your Contena Frontend in the browser as usual —\n' +
