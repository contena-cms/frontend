 ...
 *    (e.g. `'../../vendor/quickview-abc123.js'` → `'@contena-ag/dive/quickview'`)
 ...
 *    {
 *      "manifest": { ... },
 *      "vendorMap": { "@contena-ag/dive/quickview": "vendor/quickview-abc123.js" }
 *    }
 *
 * Design notes
 * ------------
 ...
 * two reasons:
 *
 *   - A package may be split across many chunks (e.g. `@contena-ag/dive` →
 ...
 * (`'@contena-ag/dive'`, `'@contena-ag/dive/quickview'`, `'three'`, …), not
...
export function componentMapPlugin(): Plugin {
    ...
    return {
         ...
         *   - `contena`, which is kept external and resolved via the
